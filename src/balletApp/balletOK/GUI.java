...
public class GUI {
    ...
    // Creació de components (inicialització)
        ...
        b1.setColors(colores.getColorAt(3), 0, colores.getColorAt(2), colores.getColorAt(6));
